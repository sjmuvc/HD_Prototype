...
public class CargoManager : MonoBehaviour, IPointerClickHandler
{
    ...
    private void Start()
    {
        ...
        Destroy(virtualObject.GetComponentInChildren<CargoManager>());
        ...
        virtualObject.transform.GetChild(0).gameObject.GetComponent<VirtualObjectTrigger>().cargoManager = this.GetComponent<CargoManager>();
